...
export const SpecialOffer = () => (
	<section className='flex justify-center items-center max-xl:flex-col-reverse gap-10 max-content'>
		<div className='flex-1'>
			<img src={offer} alt='discount' width={773} height={687} className='object-contain w-full'/>
		</div>
		...
		<div className='flex flex-1 flex-col'>
			...
			<p className='mt-4 lg:max-w-lg info-text'>Embark on a shopping journey that redefines your experience with
				unbeatable dealt. From premier selections to incredible savings, we offer unparalleled value that sets us
				apart.</p>
